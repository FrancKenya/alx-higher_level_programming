...
class TestSquare_x(unittest.TestCase):
    """ Testing initialization of  x attribute."""
    ...
    def test_bytearray_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(2, bytearray(b'frank'))

    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(2, memoryview(b'frank'))

    def test_inf_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(4, float('inf'), 2)

    def test_nan_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(3, float('nan'), 3)
...
class TestSquare_y(unittest.TestCase):
    ...
    def test_bytearray_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(4, 5, bytearray(b'frank'))

    def test_memoryview_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(4, 5, memoryview(b'frank'))

    def test_inf_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(2, 2, float('inf'))

    def test_nan_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(2, 2, float('nan'))
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        ...
        Args:
            sq: The Square printed to stdout.
            method: The string to run on the square.
        Returns:
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_size_before_x(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(90, "invalid", "frank")

    def test_update_args_size_before_y(self):
        s = Square(20, 20, 20, 20)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(89, "frank", 2, "frank")

    def test_update_args_x_before_y(self):
        s = Square(20, 20, 20, 20)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            s.update(89, 1, "frank", "frank")
